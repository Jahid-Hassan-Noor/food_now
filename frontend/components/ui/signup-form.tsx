          ...
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field>
                ...
                <Input id="full_name" type="text" placeholder="Your Full Name" required />
              </Field>
              <Field>
                <FieldLabel htmlFor="username">Username</FieldLabel>
                <Input id="username" type="text" placeholder="Select an username" required />
              </Field>
              <Field>
                <FieldLabel htmlFor="id">ID</FieldLabel>
                <Input id="id" type="text" placeholder="Your student or staff ID" required />
              </Field>
              <Field>
