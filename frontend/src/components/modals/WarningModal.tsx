...
const WarningModal: React.FC<ModalProps> = ({ message, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg max-w-lg text-center">
        ...
        <h2 className="text-xl font-semibold text-yellow-600 mb-2">Warning</h2>
        <p className="text-gray-600 dark:text-gray-300">{message}</p>
        <button onClick={onClose} className="mt-6 px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">
          Okay, Got It
        </button>
      </div>
    </div>
