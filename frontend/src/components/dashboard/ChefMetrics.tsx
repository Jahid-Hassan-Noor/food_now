...
import { DollarLineIcon, ListIcon, BoxIconLine, ShootingStarIcon } from "@/icons";

type ChefMetricsProps = {
  data: any; // Replace 'any' with a more specific type if available
};


export const ChefMetrics: React.FC<ChefMetricsProps> = ({ data }) => {
  return (
